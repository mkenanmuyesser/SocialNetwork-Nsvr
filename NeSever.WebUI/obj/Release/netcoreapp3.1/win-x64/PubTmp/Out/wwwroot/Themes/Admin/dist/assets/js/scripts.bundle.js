...
KTUtil.ready(function() {
    ...
    KTLayoutHeaderMenu.init('kt_header_menu1', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu2', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu3', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu4', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu5', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu6', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu7', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu8', 'kt_header_bottom');
    KTLayoutHeaderMenu.init('kt_header_menu9', 'kt_header_bottom');
